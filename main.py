...
while running:
	...
	map_colision = [squere1,squere2,squere3,squere4,squere5,squere6,squere7,squere8,squere9,squere10,squere11,squere12,
	squere13,squere14,squere15,squere16,squere17,squere18,squere19,squere20,squere21,squere22,squere23,squere24,squere25,squere26,
	squere27]
	...
	line_parts = []
	xr,yr = x,y
	while not collide_map_point((xr,yr),map_colision) :
		line_part = point_in_direction(xr,yr,3,direction)
		line_parts.append(line_part)
		xr,yr = line_part[0],line_part[1]
	pygame.draw.line(screen, (255, 0, 0), line_parts[0] , line_parts[(len(line_parts))-1], 3)
